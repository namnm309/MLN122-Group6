...
export const ROLES: Role[] = [
  {
    ...
    goal: "Duy trì ổn định thị trường, tăng trưởng GDP và đảm bảo công bằng xã hội cùng một lúc.",
    color: "#4a8fe8",
  ...
  },
  {
    id: "business",
    label: "Doanh nghiệp",
    description: "Bạn quản lý một doanh nghiệp sản xuất. Lợi nhuận và sự sống còn của công ty phụ thuộc vào chính sách.",
    goal: "Tối đa hóa lợi nhuận, giảm chi phí đầu vào và mở rộng thị trường — trong khuôn khổ pháp luật.",
    color: "#e8943a",
  ...
  },
  {
    ...
    description: "Bạn là công nhân/nhân viên. Cuộc sống hằng ngày phụ thuộc vào lương thưởng và an toàn việc làm.",
    goal: "Tăng lương thực tế, bảo vệ việc làm và có quyền lợi lao động được đảm bảo.",
    color: "#4aad6e",
  ...
  },
  {
    id: "citizen",
    label: "Người dân",
    description: "Bạn là người tiêu dùng thông thường. Mỗi chính sách kinh tế đều ảnh hưởng trực tiếp tới ví tiền của bạn.",
    goal: "Giữ giá cả hợp lý, đời sống ổn định và sức mua không bị bào mòn bởi chính sách.",
    color: "#e0624a",
